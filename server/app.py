...
def root():
    ...
    return HTMLResponse("<h1>Medical Triage OpenEnv</h1><p>Environment is running.</p>")
...
def reset(request: ResetRequest = None):
    ...
    if request is None:
        request = ResetRequest(use_procedural=True)
    else:
        request.use_procedural = True
    ...
    try:
        while True:
            ...
            if msg_type == "reset":
                ...
                use_procedural = message.get("use_procedural", True)
